...
const CFG = {
  ...
  PARTICLE_COUNT_DESKTOP: 62,
  PARTICLE_COUNT_MOBILE: 22,

  // Ambient/free stars (persistent background)
  AMBIENT_STAR_COUNT_DESKTOP: 70,
  AMBIENT_STAR_COUNT_MOBILE: 12,
  ...
  BURST_FIELD_COUNT_DESKTOP: 20,
  BURST_FIELD_COUNT_MOBILE: 10,
