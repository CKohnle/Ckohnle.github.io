...
const CFG = {
  ...
  PARTICLE_COUNT_DESKTOP: 2800,
  PARTICLE_COUNT_MOBILE: 900,

  // Ambient/free stars (persistent background)
  AMBIENT_STAR_COUNT_DESKTOP: 4000,
  AMBIENT_STAR_COUNT_MOBILE: 1200,
  AMBIENT_STAR_SPEED_MIN: 0.45,
  AMBIENT_STAR_SPEED_MAX: 1.85,
  ...
  BURST_FIELD_COUNT_DESKTOP: 2800,
